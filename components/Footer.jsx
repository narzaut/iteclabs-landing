...
export const Footer = ({ footer }) => {
	...
	return (
		<footer id="footer" className='pt-14 pb-6 text-shadow relative gray-card flex flex-col  items-center text-gray-300 text-sm'>
			...
			<a href='#' className='h-12 w-12 rounded-full bg-gray-500 bg-opacity-60 glass  card-shadow transition-color hover:bg-gray-600 transition absolute  flex items-center justify-center cursor-pointer -top-5   animate-bounce' to='#home'>
